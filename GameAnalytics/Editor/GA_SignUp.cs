	...
	public class GA_SignUp : EditorWindow
	{
		...
		void OnGUI ()
		{
			...
			case 0: // sign up
				...
				GUILayout.Label(GameAnalytics.SettingsGA.UserIcon, new GUILayoutOption[] { GUILayout.Width(40), GUILayout.MaxHeight(40) });
				GUILayout.FlexibleSpace();
				...
				if (GUILayout.Button("Create account", new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxHeight(30) }))
				{
			...
			case 1: // add your game
				...
				GameAnalytics.SettingsGA.GameName = EditorGUILayout.TextField("", GameAnalytics.SettingsGA.GameName, new GUILayoutOption[] { GUILayout.Width(300), GUILayout.Height(30) });
				GUI.skin.textField.fontSize = tmpFontSize;
				GUI.skin.textField.contentOffset = tmpOffset;
				if (GUILayout.Button("Find your game", new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxHeight(30) }))
				{
				...
				if (_appFiguresGames != null && _appFiguresGames.Count > 0)
				{
					...
					for (int i = 0; i < _appFiguresGames.Count; i++)
					{
						...
						{
							GUILayout.Label(_appFiguresGames[i].Icon, new GUILayoutOption[] { GUILayout.Width(32), GUILayout.Height(32) });
						}
						else
						{
							GUILayout.Label("", new GUILayoutOption[] { GUILayout.Width(32), GUILayout.Height(32) });
						}
				...
				GUILayout.BeginHorizontal();
				GUILayout.FlexibleSpace();
				if (GUILayout.Button("Create new game", new GUILayoutOption[] { GUILayout.Width(200), GUILayout.Height(30) }))
				{
					_tourStep = 2;
				}
				GUILayout.FlexibleSpace();
			...
			case 3: // app figures add game
				...
				GUILayout.BeginHorizontal();
				GUILayout.FlexibleSpace();
				if (GUILayout.Button("Create new game", new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxHeight(30) }))
				{
					_tourStep = 2;
				}
				GUILayout.FlexibleSpace();
			...
			case 4:
				...
				GUILayout.BeginHorizontal();
				GUILayout.FlexibleSpace();
				GUILayout.Label(GameAnalytics.SettingsGA.Logo, new GUILayoutOption[] { GUILayout.Width(40), GUILayout.Height(40) });
				GUILayout.FlexibleSpace();
				GUILayout.EndHorizontal();
				...
				GUILayout.BeginHorizontal();
				GUILayout.FlexibleSpace();
				if (GUILayout.Button("Start guide", new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxHeight(30) }))
				{
					_tourStep = 5;
				}
				GUILayout.FlexibleSpace();
			...
			case 14:
				...
				int guideStep = _tourStep - 4;

				GUILayout.Space(20);
				
				GUILayout.BeginHorizontal();
				GUILayout.FlexibleSpace();
				GUILayout.Label(GameAnalytics.SettingsGA.InstrumentIcon, new GUILayoutOption[] { GUILayout.Width(40), GUILayout.Height(40) });
				GUILayout.FlexibleSpace();
				GUILayout.EndHorizontal();
				...
				foreach (StringWithType s in guideStepTexts)
				{
					...
					else if (s.Type == StringType.TextBox)
					{
						...
						GUILayout.TextField(s.Text, new GUILayoutOption[] { GUILayout.MaxWidth(550), GUILayout.Height(34) });
		...
		private StringWithType[] GetGuideStepText (int step)
		{
			...
			case 1:
				return new StringWithType[] {
					...
					new StringWithType { Text = "Click here to learn more about the Game and Secret keys.", Type = StringType.Link, Link = "https://github.com/GameAnalytics/GA-SDK-UNITY/wiki/Settings#setup" },
				};
			case 2:
				return new StringWithType[] {
					...
					new StringWithType { Text = "" },
					new StringWithType { Text = "Click here to learn more about the full list of core metrics and dimensions.", Type = StringType.Link, Link = "http://www.gameanalytics.com/docs/metric-and-dimensions-reference/" }
				};
			case 3:
				return new StringWithType[] {
					...
					new StringWithType { Text = "using GameAnalyticsSDK;", Type = StringType.TextBox },
					new StringWithType { Text = "" },
			...
			case 4:
				return new StringWithType[] {
					...
					new StringWithType { Text = "GameAnalytics.NewBusinessEvent (string currency, int amount, string itemType, string itemId, string cartType, string receipt, bool autoFetchReceipt);", Type = StringType.TextBox },
					new StringWithType { Text = "" },
					new StringWithType { Text = "Click here to learn more about the Business event and purchase validation.", Type = StringType.Link, Link = "https://github.com/GameAnalytics/GA-SDK-UNITY/wiki/Business%20Event" }
				};
			case 5:
				return new StringWithType[] {
					...
					new StringWithType { Text = "GameAnalytics.NewResourceEvent (GA_Resource.GAResourceFlowType flowType, string resourceType, float amount, string itemType, string itemId);", Type = StringType.TextBox },
					...
					new StringWithType { Text = "" },
					new StringWithType { Text = "Click here to learn more about the Resource event.", Type = StringType.Link, Link = "https://github.com/GameAnalytics/GA-SDK-UNITY/wiki/Resource%20Event" }
				};
			case 6:
				return new StringWithType[] {
					...
					new StringWithType { Text = "GameAnalytics.NewProgressionEvent (GA_Progression.GAProgressionStatus progressionStatus, string progression01, string progression02);", Type = StringType.TextBox },
					new StringWithType { Text = "" },
					new StringWithType { Text = "Click here to learn more about the Progression event.", Type = StringType.Link, Link = "https://github.com/GameAnalytics/GA-SDK-UNITY/wiki/Progression%20Event" }
				};
			case 7:
				return new StringWithType[] {
					...
					new StringWithType { Text = "GameAnalytics.NewDesignEvent (string eventName, float eventValue);", Type = StringType.TextBox },
					new StringWithType { Text = "" },
					new StringWithType { Text = "Click here to learn more about the Design event.", Type = StringType.Link, Link = "https://github.com/GameAnalytics/GA-SDK-UNITY/wiki/Design%20Event" }
				};
			case 8:
				return new StringWithType[] {
					...
					new StringWithType { Text = "GameAnalytics.NewErrorEvent (GA_Error.GAErrorSeverity severity, string message);", Type = StringType.TextBox },
					new StringWithType { Text = "" },
					new StringWithType { Text = "Click here to learn more about the Error event.", Type = StringType.Link, Link = "https://github.com/GameAnalytics/GA-SDK-UNITY/wiki/Error%20Event" }
				};
			case 9:
				return new StringWithType[] {
					...
					new StringWithType { Text = "GameAnalytics.SetCustomDimension01(string customDimension);", Type = StringType.TextBox },
					new StringWithType { Text = "" },
					new StringWithType { Text = "Click here to learn more about Custom Dimensions.", Type = StringType.Link, Link = "https://github.com/GameAnalytics/GA-SDK-UNITY/wiki/Set%20Custom%20Dimension" }
				};
			case 10:
				return new StringWithType[] {
		...
		private void PaintAppStoreIcon (string storeName)
		{
			...
			case "amazon_appstore":
				...
				{
					//GUILayout.Label("", GUILayout.Height(-20));
					GUILayout.Label(GameAnalytics.SettingsGA.AmazonIcon, new GUILayoutOption[] { GUILayout.Width(20), GUILayout.MaxHeight(20) });
				}
			...
			case "google_play":
				...
				{
					//GUILayout.Label("", GUILayout.Height(-20));
					GUILayout.Label(GameAnalytics.SettingsGA.GooglePlayIcon, new GUILayoutOption[] { GUILayout.Width(20), GUILayout.MaxHeight(20) });
				}
			...
			case "apple:ios":
				...
				{
					//GUILayout.Label("", GUILayout.Height(-20));
					GUILayout.Label(GameAnalytics.SettingsGA.iosIcon, new GUILayoutOption[] { GUILayout.Width(20), GUILayout.MaxHeight(20) });
				}
			...
			case "apple:mac":
				...
				{
					//GUILayout.Label("", GUILayout.Height(-20));
					GUILayout.Label(GameAnalytics.SettingsGA.macIcon, new GUILayoutOption[] { GUILayout.Width(20), GUILayout.MaxHeight(20) });
				}
			...
			case "windows_phone":
				...
				{
					//GUILayout.Label("", GUILayout.Height(-20));
					GUILayout.Label(GameAnalytics.SettingsGA.windowsPhoneIcon, new GUILayoutOption[] { GUILayout.Width(20), GUILayout.MaxHeight(20) });
				}
