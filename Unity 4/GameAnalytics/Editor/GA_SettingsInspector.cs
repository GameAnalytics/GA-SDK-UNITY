		...
		public override void OnInspectorGUI()
		{
			...
			else
			{
				...
				else if(ga.CurrentInspectorState == Settings.InspectorStates.Basic)
				{
					...
					GUILayout.BeginHorizontal();
					GUILayout.Label("", GUILayout.Width(-18));
					EditorGUILayout.HelpBox("PLEASE NOTICE: Remember to exclude (if not already excluded) GA Mono DLLs by clicking on menu Window -> GameAnalytics -> Exclude GA Mono DLLs.", MessageType.Info);
					...
					GUILayout.BeginHorizontal();
					GUILayout.Label("", GUILayout.Width(-18));
					EditorGUILayout.HelpBox("PLEASE NOTICE: Remember to include (if not already included) GA Mono DLLs by clicking on menu Window -> GameAnalytics -> Include GA Mono DLLs.", MessageType.Info);
